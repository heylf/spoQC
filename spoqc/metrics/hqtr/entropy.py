...
def _pixel_entropy(figure_path, img, imagedim, name, spoqc_tmp_folder, tmp_suffix, mode="reflect", window_size=5):
    ...
    helperfuncs.nparr_to_parquet(entropy_image.flatten(), name, spoqc_tmp_folder, tmp_suffix)
