...
def plot_funkyheatmap(rna, figure_path):
    ...
    plt.savefig(f'{figure_path}/funkyheatmap_10x_breast.png', bbox_inches='tight', dpi=300)
    plt.savefig(f'{figure_path}/funkyheatmap_10x_breast.pdf', bbox_inches='tight', dpi=300)
    plt.close()