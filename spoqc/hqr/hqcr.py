...
def islandqc(sdata, figure_path, distance_threshold, min_group_count):
...
def start_hqcr(sdata, spoqc_tmp_folder, imagedim, CONST, seed):
    ...
    return cell_df, qc_metrices


def plots_hqcr(sdata, figure_path, cell_df, qc_metrices):
    figure_path = f'{figure_path}/hqcr/hqcr_ident/'
