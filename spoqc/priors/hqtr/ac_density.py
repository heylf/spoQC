...
def _calc_prior(
    ...
    # Load data
    tmp_files = f'{spoqc_tmp_folder}/ac_density_output_hqtr'
    ...
    helperfuncs.plot_pixels(
        ...
        imagedim,
        'prob_ac_density',
        'Probability of AC Density Pixel', 
        'hot',
        False,
        False
    )
...
def init_prior(enterprise):
    ...
    modality = "hqtr"
    tmp_path = None
    needs_metrics = ["ac_density"]

    # These are given by your prior calc function.
    args = [enterprise.args.tmp_dir, f"{enterprise.args.output_dir}/hqtr/hqtr_ac/", 
