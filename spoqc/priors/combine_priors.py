...
def combine_priors_hqcr(sdata, figure_path, cell_df, qc_domains_adata, counts, doublet_prior_std, doublet_prior_mean):
    ...
    prior_doublet = priors.hqcr.doublet_distance.calc_probs_ddd(sdata, figure_path, doublet_prior_std, mean=doublet_prior_mean)
