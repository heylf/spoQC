...
2. Write an individual script for the calculation of the metric and place it in the [spoqc metrics folder](#spoqcmetrics).
3. Write a prior estimation for the individual metric and place it in the [spoqc priors folder](#spoqcpriors).
