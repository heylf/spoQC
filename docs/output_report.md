# Explanations to all report plots
...
- [Data](#data)
    - [Staining log](#staining_log)
    - [SpoQC annotated QC anndata](#rna_qc_annotated)
    - [Spatialdata metadata](#spatialdata-metadata)
...
- [HQCR](#hqcr)
    - [hqcr/hqcr_ident](#hqcr_ident)
    - [hqcr/hqcr_celltype](#hqcr_celltype)
- [HQPR](#hqpr)
    - [hqpr/hqpr_bounding_box](#hqpr_bounding_box)
    - [hqpr/hqpr_celltype](#hqpr_celltype)
    - [hqpr/hqpr_refinement](#hqpr_refinement)
- [HQTR](#hqtr)
    - [hqtr/hqtr_ac](#hqtr_ac)
    - [hqtr/hqtr_bounding_box](#hqtr_bounding_box)
    - [hqtr/hqtr_celltype](#hqtr_celltype)
    - [hqtr/hqtr_clustering](#hqtr_clustering)
    - [hqtr/hqtr_qv](#hqtr_qv)
    - [hqtr/hqtr_refinement](#hqtr_refinement)
- [Others](#others)
    - [Staining Log](#staining_logtxt)
    - [QC annotated anndata](#rna_qc_annotatedh5ad)
    - [SpatialData Metadata](#spatialdata-metadata)
    - [ambientqc](#ambientqc)
    - [cellcycleqc](#cellcycleqc)
    - [cellqc](#cellqc)
    - [doubletqc](#doubletqc)
    - [generalqc](#generalqc)
    - [voidqc](#voidqc)
...
Please have a look at [Staining Log](#staining_logtxt) for more explanation.

## imageplot_final

<img src="../figures/tutorial/combine_masks/0/imageplot_final.png" width="800">
...
<img src="../figures/tutorial/combine_masks/0/imageplot_combined_beliefs.png" width="800">
...
<img src="../figures/tutorial/combine_masks/0/imageplot_hqcr.png" width="800">
...
<img src="../figures/tutorial/combine_masks/0/imageplot_hqcr_beliefs.png" width="800">
...
<img src="../figures/tutorial/combine_masks/0/venn_combined_masks.png" width="400">
...
This folder holds plots that investigates the quality more deeply. You can use these plots to get an initial understanding. We recommend to use the [QC annotated anndata] (#rna_qc_annotatedh5ad) so you have full control and can generate your own plots. Feel free to dig around spoQC`s code base to get some of the plots we use and adapt them to your personal need.
...
In the default mode spoQC's picks the cell type cluster with the highest number of cells. You can provide with `--cluster_celltype` a cell type name to directly analysis a specific cluster or just use the [QC annotated anndata](#rna_qc_annotatedh5ad), then you have directly control.
...
<img src="../figures/tutorial/hqcr/hqcr_ident/markov_random_field_calculations.png" width="600">
...
<img src="../figures/tutorial/hqcr/hqcr_ident/hqcr/scatterplot_hqcr_1.png" width="400">
...
<img src="../figures/tutorial/hqcr/hqcr_ident/lqcr/scatterplot_lqcr_1029.png" width="400">
...
<img src="../figures/tutorial/hqcr/hqcr_ident/scatterplot_refined_qc_class.png" width="400">
...
<img src="../figures/tutorial/hqcr/hqcr_celltype/markov_random_field_calculations.png" width="600">
...
<img src="../figures/tutorial/hqpr/0/hqpr_bounding_box/imageplot_marked_merged_subfigures.png" width="600">

Bounding box (red) of merge subfigures (overlapping) bounding boxes of HQPRs.

### imageplot_marked_subfigures

<img src="../figures/tutorial/hqpr/0/hqpr_bounding_box/imageplot_marked_subfigures.png" width="600">

Bounding box (red) of identified HQPRs.

### subfigures/

<img src="../figures/tutorial/hqpr/0/hqpr_bounding_box/subfigures/imageplot_subfigure1.png" width="600">
...
<img src="../figures/tutorial/hqpr/0/hqpr_refinement/markov_random_field_calculations
.png" width="600">
...
<img src="../figures/tutorial/hqtr/hqtr_ac/histogram_transcript_ac.png" width="400">

This plot is useful to adjust the threshold for the ambient RNA consideration.

### imageplot_norm_p_ac_density

<img src="../figures/tutorial/hqtr/hqtr_ac/imageplot_norm_p_ac_density.png" width="600">
...
<img src="../figures/tutorial/hqtr/hqtr_ac/imageplot_transcript_global_autocorrelation_density.png" width="600">

Spatial plot of the global Moran's I density.

### imageplot_transcript_local_autocorrelation_density

<img src="../figures/tutorial/hqtr/hqtr_ac/imageplot_transcript_local_autocorrelation_density.png" width="600">

Spatial plot of the global Moran's I density.

### imageplot_transcript_autocorrelation_density

<img src="../figures/tutorial/hqtr/hqtr_ac/imageplot_transcript_autocorrelation_density.png" width="600">
...
<img src="../figures/tutorial/hqtr/hqtr_bounding_box
...
<img src="../figures/tutorial/hqtr/hqtr_bounding_box/subfigures
...
<img src="../figures/tutorial/hqtr/hqtr_clustering
...
<img src="../figures/tutorial/hqtr/hqtr_qv
...
<img src="../figures/tutorial/hqtr/hqtr_refinement
...
<img src="../figures/tutorial/ambientqc/contamination_global_morans_I.png" width="400">
...
<img src="../figures/tutorial/cellcycleqc/scatterplot_densityplot_phase_1.png" width="700">

Spatial plot of cell density based on the different cellcycle phases.

### barplot_sample_cellcycle_fractions

<img src="../figures/tutorial/cellcycleqc/barplot_sample_cellcycle_fractions.png" width="400">
...
<img src="../figures/tutorial/cellqc/scatterplot_border_cell.png" width="400">
...
<img src="../figures/tutorial/cellqc/scatterplot_densityplot_num_low_qc_transcript.png" width="400">

Spatial-density plot of the cells, where the density is weighted by the number of low quality (qc < 20) transcripts.

### scatterplot_island

<img src="../figures/tutorial/cellqc/scatterplot_island.png" width="400">
...
<img src="../figures/tutorial/cellqc/scatterplot_densityplot_convexity_cell_convexity_metric_cell.png" width="400">
...
<img src="../figures/tutorial/cellqc/scatterplot_densityplot_convexity_nuclei_convexity_mean_nuceli.png" width="400">
...
<img src="../figures/tutorial/cellqc/scatterplot_densityplot_convexity_nuclei_convexity_metric_cell.png" width="400">
...
<img src="../figures/tutorial/cellqc/scatterplot_densityplot_nucleus_free.png" width="400">
...
<img src="../figures/tutorial/doubletqc/histogram_signal_integrity_and_signal.png" width="400">
...
<img src="../figures/tutorial/doubletqc/scatterplot_densityplot_doublet.png" width="400">
...
<img src="../figures/tutorial/doubletqc/scatter_signal_integrity_3d.png" width="400">
...
<img src="../figures/tutorial/doubletqc/spatial_signal_integrity_map.png" width="800">
...
<img src="../figures/tutorial/doubletqc/doublet_case_0.png" width="800">
...
<img src="../figures/tutorial/generalqc/scatterplot_densityplot_invalid_cell_geometry.png" width="400">

Density map of invalid cell geometries in the data. Each dot is a polygon.

### scatterplot_densityplot_invalid_nucleus_geometry

<img src="../figures/tutorial/generalqc/scatterplot_densityplot_invalid_nucleus_geometry.png" width="400">

Density map of invalid nucleus geometries in the data. Each dot is a polygon.

### invalid_cell_geomtry_*

<img src="../figures/tutorial/generalqc/invalid_cell_geomtry_0.png" width="200">

Example of invalid cell geometries.

### invalid_nucleus_geomtry_*

<img src="../figures/tutorial/generalqc/invalid_nucleus_geomtry_0.png" width="200">
...
<img src="../figures/tutorial/voidqc/spatial_traingle_all_clsuters_log10_transcripts_counts_outside_cell.png" width="400">
