...
[![PyPI](https://img.shields.io/pypi/v/spoqc.svg)](https://pypi.org/project/spoqc/)
...
The workflow is available on the **dev branch** of [nf-core/spatialaxe](https://github.com/nf-core/spatialaxe/tree/dev).
